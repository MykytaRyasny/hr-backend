...
DROP
DATABASE IF EXISTS RRHH;
CREATE
DATABASE IF NOT EXISTS RRHH;
USE
RRHH;
...
-- Insert Library
INSERT INTO books (ISBN, TITLE, RELEASE_DATE, AUTOR)
VALUES ('1234567890', 'La sombra del viento', '2001-05-01', 'Carlos Ruiz Zafón');
INSERT INTO books (ISBN, TITLE, RELEASE_DATE, AUTOR)
VALUES ('9876543210', '1984', '1949-06-08', 'George Orwell');
INSERT INTO books (ISBN, TITLE, RELEASE_DATE, AUTOR)
VALUES ('5678901234', 'El señor de los anillos', '1954-07-29', 'J.R.R. Tolkien');
INSERT INTO books (ISBN, TITLE, RELEASE_DATE, AUTOR)
VALUES ('0987654321', 'Cien años de soledad', '1967-05-30', 'Gabriel García Márquez');
INSERT INTO books (ISBN, TITLE, RELEASE_DATE, AUTOR)
VALUES ('5432109876', 'Don Quijote de la Mancha', '1605-01-16', 'Miguel de Cervantes');
